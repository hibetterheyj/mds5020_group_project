...
def main() -> None:
    """Main function to execute the Linear SVM modeling pipeline

    This pipeline uses the LinearSVMModel class with LinearSVC for classification.
    It's optimized for linear classification tasks with different penalty options.
    """
    print("Bank Marketing Classification - Linear SVM Model")
    print("=" * 50)

    # Initialize paths
    train_path = "../data/bank_marketing_train.csv"
    test_path = "../data/bank_marketing_test.csv"
    output_path = "../tests/bank_marketing_test_scores_linear_svm.csv"
    ...
    try:
        ...
        predictions = linear_svm_model.predict_proba(X_test_processed)
        ...
        cv_results = linear_svm_model.get_cv_performance()
        ...
        try:
            ...
            linear_svm_model.visualize_hyperparameter_tuning(
