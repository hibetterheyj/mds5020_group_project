...
# Logistic Regression 随机搜索参数分布
lr_param_dist = {
    'C': uniform(0.001, 10),  # 正则化强度的倒数
    'penalty': ['l1', 'l2', 'elasticnet'],
    'solver': ['liblinear', 'saga'],
    'max_iter': randint(100, 1000),
    'l1_ratio': uniform(0, 1)  # 用于elasticnet
}
...
print(f"\nLogistic Regression Best Parameters: {random_search.best_params_}")
print(f"Logistic Regression Best ROC-AUC Score: {random_search.best_score_:.4f}")
print(f"Logistic Regression Total Time: {total_time:.2f} seconds")

# Train final model with best parameters
print("\nTraining final Logistic Regression model with best parameters...")
final_model = LogisticRegression(**random_search.best_params_, random_state=42)
final_model.fit(X_train, y_train)

print("Final Logistic Regression model training completed!")
...
print("\nFinal Logistic Regression Model Cross-Validation Performance:")
...
print("\nStarting Logistic Regression prediction...")
...
print(f"Logistic Regression prediction time: {predict_time:.2f} seconds")

test_df['prediction'] = predictions
test_df['probability_yes'] = prediction_proba[:, 1]

test_df[['prediction', 'probability_yes']].to_csv('predictions_logistic_regression_final.csv', index=False)
print("Logistic Regression prediction completed! Results saved to predictions_logistic_regression_final.csv")

print("\nLogistic Regression Prediction Results Statistics:")
